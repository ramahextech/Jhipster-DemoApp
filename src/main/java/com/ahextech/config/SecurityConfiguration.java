...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http
            .csrf().
         csrfTokenRepository(CookieCsrfTokenRepository.withHttpOnlyFalse()).ignoringAntMatchers("/api/registration").ignoringAntMatchers("/api/login").ignoringAntMatchers("/api/profile").ignoringAntMatchers("/api/reportgeneration")
        .and()
        ...
        .and()
            ...
            .antMatchers("/api/reportgeneration").permitAll()
